			...
			<div class="navigation">
			 <span class="menu"></span> 
				<ul class="navig">
					...
					<li><a href="#features" class="scroll">link 1</a><span> </span></li>
					<li><a href="#countdown" class="scroll">link 2</a><span> </span></li>
					<li><a href="#pricing" class="scroll">link 3</a><span> </span></li>
					<li><a href="#contact" class="scroll">Contacto</a><span> </span></li>
					<li><a href="#testimonials" class="scroll">Cerrar sesion</a><span> </span></li>
				</ul>
			</div>
				 <!-- script-for-menu -->
		 <script>
